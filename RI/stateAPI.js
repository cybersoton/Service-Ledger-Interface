...
var fs = require('fs');
var url = require( "url" );
var hyperledgerState = require("./hyperledger/hyperledgerState");
...
module.exports.store = function(req,res){	
	if(blockchain == "hyperledger"){		
		hyperledgerState.store(req,res);
	} else {
...
module.exports.update = function(req,res){	    
	if(blockchain == "hyperledger"){		
		hyperledgerState.update(req,res);
	} else {
		res.writeHead(200);
...
module.exports.delete = function(req,res){	    
	if(blockchain == "hyperledger"){		
		hyperledgerState.delete(req,res);
	} else {
		res.writeHead(200);
